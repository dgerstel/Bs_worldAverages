...
## update PDG 2017 = Summer 2016 writeup
...
ResDir = "../Results/"
outputFile = ResDir + "Results_GsDGs_and_PhisDGs_Summer2016.txt"
...
def drawHFAGlogo(leftBottom, plotWidth, plotHeight, ax=ax, plt=plt):
    ...
    plt.text(x+.5*dx, y+ddy+0.5*height_w, "Summer 2016", verticalalignment='center', horizontalalignment='center',
